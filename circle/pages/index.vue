                ...
                <ul>
                  ...
                  <li class="settings">
                    ...
                    <ul class="box-dropdown drop-dropdown">
                      <li>
                        <a href="#">
                          <img src="~assets/images/cuntry/1.jpg" alt /> English
                        </a>
                      </li>
                      <li>
                        <a href="#">
                          <img src="~assets/images/cuntry/2.jpg" alt /> Francies
                        </a>
                      </li>
                    </ul>
                  </li>
                ...
                <ul class="offcanvas_main_menu">
                    ...
                    <ul class="sub-menu">
                      ...
                      <li class="menu-item-has-children">
                        ...
                        <ul class="sub-menu">
                          ...
                          <li>
                            <a href="product-details-external.html">Product external</a>
                          </li>
                          <li>
                          ...
                          <li>
                            <a href="product-details-bottomtab.html">Tab style - 1</a>
                          </li>
                          <li>
                            <a href="product-details-lefttab.html">Tab style - 2</a>
                          </li>
                          <li>
                            <a href="product-details-righttab.html">Tab style - 3</a>
                          </li>
                          <li>
                            <a href="product-details-stickyleft.html">Product sticky left</a>
                          </li>
                          <li>
                            <a href="product-details-stickyright.html">Product sticky right</a>
                          </li>
                          <li>
                            <a href="product-details-galleryleft.html">Product leftside Gallery</a>
                          </li>
                          <li>
                            <a href="product-details-galleryright.html">Product rightside Gallery</a>
                          </li>
                          <li>
                            <a href="product-details-sliderbox.html">Product Sliderbox</a>
                          </li>
                        </ul>
                      </li>
                    </ul>
                    ...
                    <ul class="sub-menu">
                      <li class="menu-item-has-children">
                        ...
                        <ul class="sub-menu">
                          ...
                          <li>
                            <a href="blog-grid-fullwidth.html">Full Width</a>
                          </li>
                        </ul>
                      </li>
                      <li class="menu-item-has-children">
                        ...
                        <ul class="sub-menu">
                          ...
                          <li>
                            <a href="blog-list-fullwidth.html">Full Width</a>
                          </li>
                        </ul>
                      </li>
                      <li class="menu-item-has-children">
                        ...
                        <ul class="sub-menu">
                          ...
                          <li>
                            <a href="blog-details-fullwidth.html">Full Width</a>
                          </li>
                        </ul>
                      </li>
                      <li class="menu-item-has-children">
                  ...
                  <li class="menu-item-has-children">
                    ...
                    <ul class="sub-menu">
                      ...
                      <li>
                        <a href="faq.html">Frequently Question</a>
                      </li>
                      <li>
                        <a href="my-account.html">My Account</a>
                      </li>
        ...
        <div class="container">
          <div class="row align-items-center">
            <div class="col-lg-3 col-6">
              <div class="logo">
                <a href="index.html">
                  <img src="~assets/images/logo/pos-circle-logo.jpg" alt class="img-fluid" />
                </a>
              </div>
            </div>
                      ...
                      <ul class="sub-menu">
                        <li class="menu-item-has-children">
                          ...
                          <ul class="sub-menu">
                            ...
                            <li>
                              <a href="shop-fullwidth.html">Pant</a>
                            </li>
                            <li>
                              <a href="shop-fullwidth-list.html">Shoes</a>
                            </li>
                          </ul>
                        </li>
                        <li class="menu-item-has-children">
                    ...
                    <li class="menu-item-has-children">
                      ...
                      <ul class="sub-menu">
                        <li class="menu-item-has-children">
                          ...
                          <ul class="sub-menu">
                            <li>
                              <a href="shop.html">Cords & Cables</a>
                            </li>
                            <li>
                              <a href="shop-fullwidth.html">Wireless</a>
                            </li>
                            <li>
                              <a href="shop-fullwidth-list.html">Accessories</a>
                            </li>
                          </ul>
                        </li>
                        <li class="menu-item-has-children">
                      ...
                      <li>
                        ...
                        <div class="mega-menu dropdown">
                          <ul class="mega-menu-inner d-flex">
                            ...
                            <li>
                              ...
                              <ul>
                                ...
                                <li>
                                  <a
                                    href="product-details-galleryleft.html"
                                  >Product leftside Gallery</a>
                                </li>
                                <li>
                                  <a
                                    href="product-details-galleryright.html"
                                  >Product rightside Gallery</a>
                                </li>
                                <li>
                                  <a href="product-details-sliderbox.html">Product Sliderbox</a>
                                </li>
                          ...
                          <div class="mega-menu-banner mt-30">
                            <a href="shop.html">
                              <img src="~assets/images/bg/custom_banner.jpg" alt />
                            </a>
                          </div>
                        </div>
                      </li>
        ...
        <div class="row">
          <div class="col-lg-4 col-md-4 col-12 text-center">
            <div class="single-banner mt-30">
              <a href="#">
                <img src="~assets/images/banner/banner1-1.png" alt class="img-fluid" />
              </a>
            </div>
          </div>
          <div class="col-lg-4 col-md-4 col-12 text-center">
            <div class="single-banner mt-30">
              <a href="#">
                <img src="~assets/images/banner/banner2-2.png" alt class="img-fluid" />
              </a>
            </div>
          </div>
          <div class="col-lg-4 col-md-4 col-12 text-center">
            <div class="single-banner mt-30">
              <a href="#">
                <img src="~assets/images/banner/banner3-3.png" alt class="img-fluid" />
              </a>
            </div>
          </div>
        </div>
        ...
        <div class="row">
                ...
                <div class="product-item">
                  ...
                  <div class="product-caption">
                    ...
                    <div class="product-pre-content mb-30">
                      <p>The S-Series Full HD TCL Roku TV puts all your favorites in one place, seamless access to...</p>
                    </div>
                    <div class="countdown">
                      <div class="box-countdown">
                        ...
                        <div data-countdown="2021/12/24"></div>
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <div class="product-list-content">
                  <div class="single-product-list mb-20">
                    ...
                    <div class="product-caption">
                      <div class="product-name">
                        ...
                        >Natus erro at congue massa commodo sit dignissim</a>
                      </div>
                      <div class="rating">
                        <span class="yellow">
                          <i class="fa fa-star"></i>
                  ...
                  <div class="single-product-list mb-20">
                    ...
                    <div class="product-caption">
                      <div class="product-name">
                        <a
                          href="product-details.html"
                        >Mirum est notare tellus eu nibh iaculis pretium</a>
                      </div>
                      <div class="rating">
                        <span class="yellow">
                          <i class="fa fa-star"></i>
                  ...
                  <div class="single-product-list mb-20">
                    <div class="product-list-image">
                      <a href="product-details.html">
                        <img
                          src="~assets/images/feature/feature-13.jpg"
                          alt
                          class="img-fluid block-one"
                        />
                        <img
                          src="~assets/images/feature/feature-12.jpg"
                          alt
                          class="img-fluid block-two"
                        />
                      </a>
          ...
          <div class="col-lg-9">
                  ...
                  <div class="item-product double-product mb-20">
                    <div class="product-thumb">
                      ...
                      <div class="action-link">
                        ...
                        <a class="compare-add same-link" href="compare.html" title="Add to compare">
                          <i class="zmdi zmdi-refresh-alt"></i>
                        </a>
                        <a
                          class="wishlist-add same-link"
                          href="wishlist.html"
            ...
            <div class="banner-area">
              <div class="single-banner mt-30">
                <a href="#">
                  <img src="~assets/images/banner/banner2-4.png" alt class="img-fluid" />
                </a>
              </div>
            </div>
                ...
                <div class="product-row">
                  ...
                  <div class="item-product">
                    ...
                    <div class="product-caption">
                      ...
                      <div class="cart">
                        <div class="add-to-cart">
                          <a class="cart-plus" href="shopping-cart.html" title="Add to cart">
                            <i class="zmdi zmdi-shopping-cart-plus zmdi-hc-fw"></i>
                          </a>
                        </div>
                      </div>
                ...
                <div class="product-row">
                  ...
                  <div class="item-product">
                    ...
                    <div class="product-caption">
                      ...
                      <div class="cart">
                        <div class="add-to-cart">
                          <a href="shoppint-cart.html" title="Add to cart">
                            <i class="zmdi zmdi-shopping-cart-plus zmdi-hc-fw"></i>
                          </a>
                        </div>
                      </div>
        ...
        <div class="row">
          <div class="col-lg-12">
            <ul class="nav nav-tabs category-tabs">
              <li class="nav-item">
                <a class="nav-link active" id="four-tab" data-toggle="tab" href="#four">
                  <span>
                    <img src="~assets/images/category/thumb-1.png" alt class="img-fluid" />
                  </span>
              ...
              <li class="nav-item">
                <a class="nav-link" id="five-tab" data-toggle="tab" href="#five">
                  <span>
                    <img src="~assets/images/category/thumb-2.png" alt class="img-fluid" />
                  </span>
              ...
              <li class="nav-item">
                <a class="nav-link" id="six-tab" data-toggle="tab" href="#six">
                  <span>
                    <img src="~assets/images/category/thumb-3.png" alt class="img-fluid" />
                  </span>
              ...
              <li class="nav-item">
                <a class="nav-link" id="seven-tab" data-toggle="tab" href="#seven">
                  <span>
                    <img src="~assets/images/category/thumb-4.png" alt class="img-fluid" />
                  </span>
              ...
              <li class="nav-item">
                <a class="nav-link" id="eight-tab" data-toggle="tab" href="#eight">
                  <span>
                    <img src="~assets/images/category/thumb-5.png" alt class="img-fluid" />
                  </span>
              ...
              <li class="nav-item">
                <a class="nav-link" id="nine-tab" data-toggle="tab" href="#nine">
                  <span>
                    <img src="~assets/images/category/thumb-6.png" alt class="img-fluid" />
                  </span>
            ...
            <div class="tab-content">
              <div
                class="product-thing-tab slick-custom-default tab-pane fade show active"
                id="four"
              >
                <!-- Single-Product-Start -->
                <div class="item-product">
            ...
            <div class="blog-post-carousel slick-custom slick-custom-default nav-top">
              <div class="blog-post-container">
                <div class="single_blog mb-35">
                  <div class="blog_thumb single-banner">
                    <a href="blog-fullwidth.html">
                      <img src="~assets/images/blog/blog-post-1.jpg" alt class="img-fluid" />
                    </a>
                  </div>
                  <div class="blog_content">
                    <h6>
                      <a href="blog-fullwidth.html">This is Secound Post For XipBlog</a>
                    </h6>
                ...
                <div class="single_blog">
                  <div class="blog_thumb single-banner">
                    <a href="blog-fullwidth.html">
                      <img src="~assets/images/blog/blog-post-2.jpg" alt class="img-fluid" />
                    </a>
                  </div>
                  <div class="blog_content">
                    <h6>
              ...
              <div class="blog-post-container">
                <div class="single_blog mb-35">
                  <div class="blog_thumb single-banner">
                    <a href="blog-fullwidth.html">
                      <img src="~assets/images/blog/blog-post-3.jpg" alt class="img-fluid" />
                    </a>
                  </div>
                  <div class="blog_content">
                    <h6>
                ...
                <div class="single_blog">
                  <div class="blog_thumb single-banner">
                    <a href="blog-fullwidth.html">
                      <img src="~assets/images/blog/blog-post-4.jpg" alt class="img-fluid" />
                    </a>
                  </div>
                  <div class="blog_content">
                    <h6>
              ...
              <div class="footer-single-widget">
                ...
                <div class="widget-body">
                  ...
                  <div class="widget-address mt-30 mb-20">
                    <p>
                      <strong>Address:</strong> 123 Main Street, Anytown, CA 12345 USA.
                    </p>
                    <p>
                      <strong>Number Phone:</strong> (800) 123 456 - (800) 123 456.
                    </p>
                    <p>
                      <strong>Address Email:</strong> support@circleshop.com
                    </p>
                  </div>
                </div>
                <div class="footer_social">
                  ...
                  <div class="widget-box mt-30">
                    ...
                    <div class="widget-single-box">
                      ...
                      <ul>
                        ...
                        <li>
                          <a href="#">Headphone Bose</a>
                        </li>
                        <li>
                          <a href="#">Headphone Nocx</a>
                        </li>
                        <li>
                          <a href="#">Wireless</a>
                        </li>
                    ...
                    <div class="widget-single-box">
                      ...
                      <ul>
                        ...
                        <li>
                          <a href="#">Frame Camera</a>
                        </li>
                        <li>
                          <a href="#">Box Camera</a>
                        </li>
                        <li>
                          <a href="#">Mini Camera</a>
                        </li>
                        <li>
                          <a href="#">XL Camera</a>
                        </li>
            ...
            <div class="col-lg-5 col-md-12 col-12">
              <div class="footer-bottom-content">
                <div class="footer-copyright">
                  <p>
                    Copyright © 2020
                    <a href="#">Circleshop</a>. All Right Reserved
                  </p>
                </div>
              </div>
            </div>
                  ...
                  <div class="product-summery mt-50">
                    ...
                    <div class="product-tax mb-20">
                      <ul>
                        <li>
                          <span>
                            <strong>Ex Tax :</strong>£60.24
                          </span>
                        </li>
                        <li>
                          <span>
                            <strong>Brands :</strong>Canon
                          </span>
                        </li>
                        <li>
                          <span>
                            <strong>Product Code :</strong>Digital
                          </span>
                        </li>
                        <li>
                          <span>
                            <strong>Reward Points :</strong>200
                          </span>
                        </li>
                        <li>
                          <span>
