      ...
      <div class="row">
        <div class="col-lg-4 col-md-5 col-sm-12">
          ...
          <a href="#" class="a-color-base">
            <h2>{{product.reviews_count}} customer reviews</h2>
          </a>
          ...
          <div class="a-row">
            ...
            <span class="a-button-base writeReviewButton cm-cr-button-wide">
              <span class="a-button-inner">
                <nuxt-link :to="`/reviews/${product.slug}`" class="a-button-text">Write a customer review</nuxt-link>
              </span>
            </span>
          </div>
          <div class="clearfix">
        ...
        <div class="col-lg-6 col-md-7 col-sm-12">
          <div class="reviews-image-gallery">
            ...
            <div class="a-spacing-small a-spacing-top-small">
              <img class="img-fluid" width="22.5%" v-for="review in reviews" :key="review.id" :src="review.image" />
            </div>
            <div>
          ...
          <div class="cr-widget-focalreviews">
            <div class="card-padding">
              ...
              <!-- Reviews -->
              <div class="review-body" v-for="review in reviews" :key="review.id">
