        ...
        <ul class="a-unordered-list a-horizontal a-size-small">
          <li>
            <span class="a-list-item">
              <a class="a-link-normal a-color-tertiary" href="#">{{product.category['name']}}</a>
            </span>
          </li>
          <li>
                  ...
                  <div class="row">
                    ...
                    <div class="col-xl-3 col-lg-3 col-md-3 col-sm-3 col-3">
                      <div class="smallAuthorImageContainer">
                        <a href="#">
                          <img src="/img/featured_product.jpg" class="img-fluid" />
                        </a>
                      </div>
                    </div>
                    <!-- Author's Name -->
            ...
            <div class="centerCol">
              ...
              <div class="titleDiv">
                <h1 class="productTitle">
                  ...
                  <span class="smallTitle">{{product.category['name']}}</span>
                </h1>
              </div>
              <!-- Author's name -->
...
export default {
  ...
  async asyncData({ $axios, params }) {
    try {
      ...
      let manyReviews = $axios.$get(`${base}/product/products/${params.id}/reviews/`)
