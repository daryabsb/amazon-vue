          ...
          <div class="card ecommerce-card">
            <div class="card-content">
              ...
              <div class="card-body">
                ...
                <div class="item-name">
                  <a href="app-ecommerce-details.html">Sony - ZX Series On-Ear Headphones - Black</a>
                </div>
                <div>
            ...
            <div class="card-content">
              ...
              <div class="item-options text-center">
                ...
                <div class="cart view-cart">
                  <i class="feather icon-shopping-cart"></i>
                  <a href="app-ecommerce-checkout.html" class="view-in-cart">
                    View
                    cart
                  </a>
                </div>
            ...
            <div class="card-content">
              ...
              <div class="card-body">
                ...
                <div class="item-name">
                  ...
                  >Garmin - fēnix 5 GPS Heart Rate Monitor Watch - Slate gray</a>
                </div>
                <div>
                  <p class="item-description">
          ...
          <div class="card ecommerce-card">
            <div class="card-content">
              ...
              <div class="card-body">
                ...
                <div class="item-name">
                  <a href="app-ecommerce-details.html">Garmin - fenix 3 Sapphire GPS Watch - Silver</a>
                </div>
                <div>
                  <p class="item-description">
            ...
            <div class="card-content">
              ...
              <div class="card-body">
                ...
                <div class="item-name">
                  <a
                    href="app-ecommerce-details.html"
                  >Amazon - Fire TV Stick with Alexa Voice Remote - Black</a>
                </div>
                <div>
                  <p class="item-description">
            ...
            <div class="card-content">
              ...
              <div class="card-body">
                ...
                <div class="item-name">
                  <a
                    href="app-ecommerce-details.html"
                  >Apple - 27" iMac with Retina 5K display - Intel Core i7 - 32GB Memory - 2TB Fusion Drive - Silver</a>
                </div>
                <div>
                  <p class="item-description">
            ...
            <div class="card-content">
              ...
              <div class="card-body">
                ...
                <div class="item-name">
                  <a
                    href="app-ecommerce-details.html"
                  >Canon - EOS 5D Mark IV DSLR Camera with 24-70mm f/4L IS USM Lens</a>
                </div>
                <div>
                  <p class="item-description">
          ...
          <div class="card ecommerce-card">
            <div class="card-content">
              <div class="item-img text-center">
                <a href="app-ecommerce-details.html">
                  <img
                    src="/app-assets/images/pages/eCommerce/11.png"
                    class="img-fluid"
                    alt="img-placeholder"
                  />
                </a>
              ...
              <div class="card-body">
                <div class="item-wrapper">
                  ...
                  <div>
                    <h6 class="item-price">$1999.98</h6>
                  </div>
                </div>
                <div class="item-name">
                  <a
                    href="app-ecommerce-details.html"
                  >Bowers & Wilkins - CM10 S2 Triple 6-1/2" 3-Way Floorstanding Speaker (Each) - Gloss Black</a>
                </div>
                <div>
                  <p class="item-description">
